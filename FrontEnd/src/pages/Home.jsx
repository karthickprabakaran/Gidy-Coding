...
const Home = () => {
  ...
  return(
    ...
    <Navbar />
    <section className="w-full px-8 py-12 grid grid-cols-1 md:grid-cols-2 items-center gap-8 max-w-6xl mx-auto bg-white mt-30">
      <div>
        <span className="block mb-4 text-xs md:text-sm text-indigo-500 font-medium">
          New Stocks  every day
        </span>
        <h3 className="text-4xl md:text-6xl font-semibold text-black">
          Let's Organize Our Products in an Hastle free Way
        </h3>
